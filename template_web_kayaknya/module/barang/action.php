    ...
    */
    ...
    if($button == "Add")
    {
        ...
        */
        ...
        mysqli_query($koneksi, " INSERT INTO barang (b_id, b_jenis, b_harga, b_keterangan) 
        ...
        mysqli_query($koneksi, " UPDATE barang SET b_id = '$barang_id',
                                                    b_jenis = '$barang_jenis',
                                                    b_harga = '$barang_harga',
                                                    b_keterangan = '$barang_keterangan'

                                                    WHERE b_id = '$barang_id' ");
