<div id="kiri">
    ...
    <div id="menu-kategori">
        ...
        dikomen soalnya ngga perlu ada ini
                ...
                while($row=mysqli_fetch_assoc($query)){
                    ...
                    if($kategori_id == $row['kategori_id']){
                        ...
                        echo "<li>
                        <a href='".BASE_URL."index.php?kategori_id=$row[kategori_id]' class='active'>$row[kategori]</a></li>";
                    }
                    else{
                        
                        echo "<li>
                        <a href='".BASE_URL."index.php?kategori_id=$row[kategori_id]'>$row[kategori]</a></li>";
                    }
                }*/
            ?>
        </ul>
            ...
            <?php
                ...
                while($row=mysqli_fetch_assoc($query)){
                    ...
                    echo "<li $style>
                            ...
                            <a href='".BASE_URL."tambah_keranjang.php?page=detail&barang_id=$row[barang_id]'>+ add to cart</a>
                            </div>
                            ";
